...
OUTPUT_FOLDER = BASE / 'output' / 'Images'
...
if __name__ == '__main__':
    os.makedirs((BASE / 'output_image').as_posix(), exist_ok=True)
    for image_name in os.listdir((BASE/'input_image').as_posix()):
        image_path = (BASE / 'input_image' / image_name).as_posix()
        pil_image = get_face_recognition(image_path)
        output_path = (BASE / 'output_image' / image_name).as_posix()
